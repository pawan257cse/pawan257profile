...
const Projects = () => {
  ...
  return (
    <section id="projects" className={`py-16 sm:py-20 md:py-24 relative overflow-hidden transition-colors duration-300 ${
      isDarkMode 
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 sm:gap-8">
            {filteredProjects.map((project, index) => (
              <div
                key={index}
                className={`bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-lg dark:shadow-2xl overflow-hidden hover:shadow-xl dark:hover:shadow-cyan-500/25 transition-all duration-300 transform hover:scale-105 border border-gray-200 dark:border-gray-700 hover:border-cyan-400 dark:hover:border-cyan-400 ${
                ...
                <div className="p-4 sm:p-6">
                  ...
                  <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center px-3 sm:px-4 py-2 text-gray-600 dark:text-gray-300 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-cyan-400 dark:hover:border-cyan-400 transition-colors duration-200 text-sm sm:text-base"
                    >
                    ...
                    {project.liveUrl !== '#' && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center justify-center px-3 sm:px-4 py-2 bg-gradient-to-r from-cyan-500 to-pink-500 text-white rounded-lg hover:from-cyan-600 hover:to-pink-600 transition-colors duration-200 text-sm sm:text-base"
                      >
